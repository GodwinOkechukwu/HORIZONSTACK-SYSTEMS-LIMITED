...
const Footer = () => {
  ...
  const footer1socialMediaIcons = [
    {
      id: 1,
      icon: <BiLogoFacebook className="text-2xl sm:text-3xl text-white" />,
      link: "",
  ...
  return (
    <footer className=" bg-[#F4F4ED] border border-[#C3C8C2] w-full py-2 flex flex-col item-center mb-[-100px]">
              ...
              <div key={index} className="flex flex-col gap-4 lg:gap-5 w-full">
                ...
                {section.links.map((link, linkIndex) => (
                  <Link
                    ...
                    className="text-black text-sm leading-[1.3] hover:text-primary-100 transition-[.3]"
                  >
                    {link.label}
                  </Link>
                ))}
              ...
              <div key={index} className="flex flex-col gap-2 sm:gap-5 w-full">
                ...
                {section.links.map((link, linkIndex) => (
                  <Link
                    key={linkIndex}
                    href={link.href}
                    className={`${link.href === pathname ? "text-primary-100" : "text-black"} text-xs sm:text-sm font-[400] hover:text-[#DC8204] transition-[.3] leading-6`}
                  >
                    {link.label}
                  </Link>
                ))}
      ...
      <div className="mx-auto max-w-[1350px]">
        <div className="flex items-center justify-center py-2">
          <div className="text-black sm:font-mono text-xs leading-[1.2]">
