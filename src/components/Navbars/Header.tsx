  ...
  return (
    <>
      <header style={{
          ...
          }} className="flex flex-col w-full bg-[#F4F4ED] z-[100] fixed top-0 border-b border-[#5F3E3E33] shadow-2xl transition-all">
        {/* Desktop Header */}
        <div
          className={`hidden slg:grid ${showSearch ? "grid-cols-2 " : "grid-cols-2 "} items-center justify-center w-full py-3 max-w-[1350px] mx-auto`}
        >
          {/* 1. Logo */}
          ...
          <div className="col-span-1 flex items-center justify-end gap-6">
            ...
            {email ? (
              ...
              <div className="relative inline-block text-left">
                <CircleUser className="text-[#434844]" fill="white" />
              </div>
            )}
          </div>
        </div>
        ...
        <div className="slg:hidden flex flex-col w-full p-4 gap-3 bg-[#F4F4ED]">
          ...
          <div className="relative h-10">
            <input
              ...
              className="w-full h-full text-sm bg-gray-700 rounded-lg px-4 border-none outline-none focus:ring-2 focus:ring-primary-100"
              value={searchValue}
              onChange={(e) => setSearchValue(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && handleSearch()}
            />
